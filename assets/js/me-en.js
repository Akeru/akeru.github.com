var _meEn = {
    ...
    "jobs": [
        {
            ...
            "projects": [
                ...
                {
                    "name": "Day to day",
                    "description": "Network deploying, configuration and maintenance (switches, routers, firewalls) and services (DNS, DHCP), level 2 support"
                },
                {
                    "name": "Plugs Project",
                    "description": "Design and development of a wiring closet management application, used daily by level 1 support"
                },
                {
                    "name": "Plugs 2 Project",
                    "description": "Design and development of a network management platform (automation, data collecting and displaying...)"
                },
                {
                    "name": "IPAM Project",
                ...
                {
                    "name": "NGFW Project",
                    "description": "Design and migration of the Internet edge firewall to a next-generation model"
                }
            ]
        },
        {
            ...
            "projects": [
                ...
                {
                    "name": "Consultancy",
                    "description": "Various PHP projects consultancy missions"
                }
            ]
        },
        {
            ...
            "company": {
                "name": "Liège University - Montefiore Institute",
        ...
        },
        {
            ...
            "projects": [
                {
                    "name": "End of study work",
                    "description": "Design and development of a new foreign exchange framework"
                }
            ]
        }
    ],
        ...
        "entries": [
            {
                ...
                "description": "Design and implementation of a free, offline tool to plan railways trip in Japan"
            },
            {
                "name": "Tagaini",
    ...
    "interests": [
        {
            "name": "Japan",
            "description": "Multiple trips (youth hostels, homestay, hotels), letters"
        },
        {
            "name": "Reading",
            "description": "Science fiction, fantasy, japanese literature"
        },
        {
            "name": "Rock climbing, Tabletop RPGs",
            "description": ""
        }
    ]
};